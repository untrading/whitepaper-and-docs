...
ERC-5173 is an Ethereum Improvement Proposal that introduces a novel concept called non-fungible Future Rewards (nFR), which is an extension for EIP-721 tokens (NFTs). This standard proposes a multigenerational reward mechanism where all previous owners of an un-token can benefit from future price appreciation, even after they have sold the token1. Essentially, when a user sells an un-token, they pay out a certain percentage of their realized profit to the previous owners. In return, the current owner becomes eligible to receive a portion of the future profits generated by subsequent owners of that specific un-token. This creates a self-perpetuating cycle where each owner stands to benefit from the potential success and increasing value of the un-token they once held, even after selling it. As the underlying asset continues to appreciate in value and generate profits for its successive owners, a portion of those gains trickles back to the previous holders, incentivizing a vested interest in the long-term growth and success of the un-token ecosystem.&#x20;

This creates a Provenance Value Amplification (PVA) framework, encouraging a collaborative effort among creators, buyers, and sellers to collectively increase the value of the asset.

<figure><img src="../.gitbook/assets/dashboard_overview_Screenshot_21-5-2024_104010_testnet.untrading.org.jpeg.png" alt=""><figcaption><p><em>Display of nFR Earned and Paid outs on a user's dashboard</em></p></figcaption></figure>
...
Here's a sample (unBTC #33) of what Originator @David Wang has received in total ORs. The Originator receives OR distributions for as long as any future owners of the token sell it with a profit. Note that Generations 9 and 14 do not receive OR payments as their holdings were unprofitable at the time of sale.&#x20;

A token's Originator, previous owners, and current owner all have access to its OR payout history.

<figure><img src="../.gitbook/assets/ORs_recd_Screenshot_21-5-2024_85029_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>The ORs that a user receives on their dashboard</em></p></figcaption></figure>
...
An owner's customized Dashboard includes a detailed history of FR income for all generations for each un-token. If, for example, unBTC #33 is designated by its originator as a 20-Gen token, Aurora will receive FR payouts from the next twenty owners (sequential owners #4 to #23) who make a profit when selling unBTC #33.

<figure><img src="../.gitbook/assets/2.4.2_FRs_recd_Screenshot_21-5-2024_9758_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>The FRs that a user receives on their dashboard</em></p></figcaption></figure>

In the same way, each user's dashboard lists all FR paid out to previous owners.

<figure><img src="../.gitbook/assets/2.4.2_FRs_paid_Screenshot_21-5-2024_92721_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>The ORs that a user paid out on their dashboard</em></p></figcaption></figure>
...
A token's nFR performance can be poor under certain market conditions due to its original parameter design (Total Reward ratio, Originator Reward ratio, Future Reward ratio, and number of generations). As a result, some owners pay out more than the total FR they receive, making the token undesirable.

Token holders (the current un-token holders) may redeem their holdings back to the underlying ERC-20 token. For the benefits of all Flow members, this process requires approval from the original creator of the unCrypto. The unwrapping process is designed to be as straightforward as the wrapping procedure, offering flexibility and choice to the token holders in managing their assets:
...
<figure><img src="../.gitbook/assets/unwrap_Screenshot_21-5-2024_102613_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>In some cases, the total amount of nFRs received is smaller than the total amount paid</em></p></figcaption></figure>

### <mark style="color:green;">2.5        PVA Specification</mark> <a href="#h.sdzwoztnri38" id="h.sdzwoztnri38"></a>
...
<figure><img src="../.gitbook/assets/nFR_Screenshot_21-5-2024_95625_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>nFR payment details, as well as user identities and blacklisted users are displayed on each token details page</em></p></figcaption></figure>
...
#### <mark style="color:green;">2.5.10</mark>       Distribution of NFT Royalties (Originators’ Rewards) to Originators <a href="#h.94w0lmnqe8uq" id="h.94w0lmnqe8uq"></a>
...
<figure><img src="../.gitbook/assets/2.5.10.1_nFR_Screenshot_21-5-2024_95625_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>OR Payments</em></p></figcaption></figure>

#### <mark style="color:green;">2.5.10.2</mark>     **Distribution of NFT Owners’ Future Rewards (FRs)**
...
<figure><img src="../.gitbook/assets/2.5.10.2_nFR_Screenshot_21-5-2024_95625_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>FR payments</em></p></figcaption></figure>

<mark style="color:green;">**2.5.10.3**</mark>**     Converting Rewards Formula into Code**
...
<figure><img src="../.gitbook/assets/dashboard_overview_Screenshot_21-5-2024_104010_testnet.untrading.org.jpeg (1).png" alt=""><figcaption><p><em>Using Dashboard to claim future rewards</em></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/2.5.12_nFR_Screenshot_21-5-2024_95625_testnet.untrading.org.jpeg" alt=""><figcaption><p><em>The chain of ownerships</em></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Initial Token Allocation %.svg" alt=""><figcaption><p>Tokenomics</p></figcaption></figure>

<table data-header-hidden><thead><tr><th width="245"></th><th width="101" align="right"></th><th></th></tr></thead><tbody><tr><td>Early Investors &#x26; Strategic Partners  </td><td align="right">6.00%</td><td>Allocated for early investors and contributors who support the project in its nascent stages, the IOB Tokenholders</td></tr><tr><td>Seed Investors</td><td align="right">4.00%</td><td>Seed investors are the early backers who provide Untrading with capital before the public token sale.</td></tr><tr><td>IDO Investors</td><td align="right">5.00%</td><td>Launchpad Token Sale available for purchase by the general public, providing a fair and transparent way for community participation.</td></tr><tr><td>Ecosystem</td><td align="right">26.00%</td><td>Aimed at fostering the platform ecosystem, including grants, and community incentives.</td></tr><tr><td>Development Fund</td><td align="right">16.00%</td><td>Reserved for ongoing development, future upgrades, and maintenance of the platform.</td></tr><tr><td>Team</td><td align="right">16.00%</td><td>Allocated to the founding members and the team, acknowledging their efforts and incentivizing continued innovation.</td></tr><tr><td>Marketing and Partnerships</td><td align="right">10.00%</td><td>Dedicated to marketing initiatives and forming strategic partnerships to enhance platform visibility and adoption.</td></tr><tr><td>Liquidity Provision</td><td align="right">10.00%</td><td>Liquidity Provision &#x26; Market Making to ensure smooth trading and price stability.</td></tr><tr><td>User Rewards</td><td align="right">4.00%</td><td>Platform Rewards Earned by Users</td></tr><tr><td>Advisors</td><td align="right">3.00%</td><td>Set aside for advisors who provide strategic guidance and expertise.</td></tr></tbody></table>
...
<table><thead><tr><th width="183"></th><th width="118">Cliff Period</th><th width="89">Vesting Duration</th><th>Vesting Schedule</th></tr></thead><tbody><tr><td>Early Investors &#x26; Strategic Partners</td><td>3 Months</td><td>4 Years</td><td>Unlocked quarterly subject to a 4-year vesting schedule with a 3-month cliff.</td></tr><tr><td>Seed Investors</td><td>1 Year</td><td>2 Years</td><td>Unlocked quarterly subject to a 2-year vesting schedule with a 1-year cliff.</td></tr><tr><td>Ecosystem &#x26; Development Fund</td><td>1 Year</td><td>5 Years</td><td>10% unlocked at launch to kickstart development, remaining 90% subject to a 5-year vesting schedule with a 1-year cliff.</td></tr><tr><td>Team</td><td>1 Year</td><td>4 Years</td><td>25% unlocked after the first year, followed by monthly vesting of the remaining 75%.</td></tr><tr><td>Marketing and Partnerships</td><td>6 Months</td><td>2 Years</td><td>50% unlocked at launch for immediate utilization, remaining 50% subject to a 2-year vesting schedule with a 6-month cliff.</td></tr><tr><td>User Rewards</td><td>6 Months</td><td>5 Years</td><td>10% unlocked at launch, remaining 90% subject to a 5-year vesting schedule with a 6-month cliff.</td></tr><tr><td>Advisors</td><td>6 Months</td><td>2 Years</td><td>Unlocked quarterly subject to a 2-year vesting schedule with a 6-month cliff.</td></tr></tbody></table>
